...
let LoginPage = class LoginPage {
    constructor(as, es, usuarioService, router, base, storage) {
        this.as = as;
        this.es = es;
    ...
    ngOnInit() {
        this.storage.get('urlBase').then((data) => {
            if (data !== null) {
                this.urlBase = data;
            }
            else {
    ...
    logar() {
        ...
        this.usuarioService.getToken(this.usuario).subscribe(data => {
            this.base.dismiss();
            this.storage.set('urlBase', this.urlBase);
            this.as.token = data;
...
LoginPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_autentificacao_autentificacao_service__WEBPACK_IMPORTED_MODULE_3__["AutentificacaoService"], _service_sigobra_empresa_service__WEBPACK_IMPORTED_MODULE_7__["EmpresaService"],
        _service_sigobra_usuario_service__WEBPACK_IMPORTED_MODULE_6__["UsuarioService"],
        _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"],
        _model_base__WEBPACK_IMPORTED_MODULE_5__["Base"],
