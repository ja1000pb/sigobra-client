...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TipoinspecaoInserirPageRoutingModule", function() { return TipoinspecaoInserirPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _tipoinspecao_inserir_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./tipoinspecao-inserir.page */ "./src/app/pages/tipoinspecao/tipoinspecao-inserir/tipoinspecao-inserir.page.ts");
...
let TipoinspecaoInserirPageRoutingModule = class TipoinspecaoInserirPageRoutingModule {
};
TipoinspecaoInserirPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TipoinspecaoInserirPageModule", function() { return TipoinspecaoInserirPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/fesm2015/ionic-angular.js");
/* harmony import */ var _tipoinspecao_inserir_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./tipoinspecao-inserir-routing.module */ "./src/app/pages/tipoinspecao/tipoinspecao-inserir/tipoinspecao-inserir-routing.module.ts");
/* harmony import */ var _tipoinspecao_inserir_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./tipoinspecao-inserir.page */ "./src/app/pages/tipoinspecao/tipoinspecao-inserir/tipoinspecao-inserir.page.ts");
...
let TipoinspecaoInserirPageModule = class TipoinspecaoInserirPageModule {
};
TipoinspecaoInserirPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
            _tipoinspecao_inserir_routing_module__WEBPACK_IMPORTED_MODULE_5__["TipoinspecaoInserirPageRoutingModule"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TipoinspecaoInserirPage", function() { return TipoinspecaoInserirPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
/* harmony import */ var _model_objetc_tipoinspecao__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./../../../model/objetc/tipoinspecao */ "./src/app/model/objetc/tipoinspecao.ts");
/* harmony import */ var _service_sigobra_tipoinspecao_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./../../../service/sigobra/tipoinspecao.service */ "./src/app/service/sigobra/tipoinspecao.service.ts");
...
let TipoinspecaoInserirPage = class TipoinspecaoInserirPage {
    constructor(tis, base, router) {
        this.tis = tis;
        this.base = base;
        this.router = router;
    ...
    salvando() {
        ...
        this.base.present();
        this.tis.salvar(this.tipoinspecao).subscribe(data => {
            this.tis.tipoinspecao = new _model_objetc_tipoinspecao__WEBPACK_IMPORTED_MODULE_4__["TipoInspecao"]();
            this.base.dismiss();
            this.router.navigate(['tipoinspecoes']);
        }, error => {
            this.base.dismiss();
            this.base.mensagemErro('Falha ao salvar tipoinspecao :' + this.base.tratarErro(error));
        });
    }
    /*itens tipo inspeção*/
    /*
   ...
   */
    itensti() {
        ...
        this.tipoinspecao.empresa = this.tis.as.token.empresa;
        this.tis.salvar(this.tipoinspecao).subscribe(data => {
            this.tis.tipoinspecao = data;
            this.router.navigate(['itenstipoinspecao']);
        }, error => {
            this.base.mensagemErro('Falha ao salvar tipo inspenção  :' + this.base.tratarErro(error));
        });
    }
};
TipoinspecaoInserirPage.ctorParameters = () => [
...
TipoinspecaoInserirPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-tipoinspecao-inserir',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./tipoinspecao-inserir.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/tipoinspecao/tipoinspecao-inserir/tipoinspecao-inserir.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./tipoinspecao-inserir.page.scss */ "./src/app/pages/tipoinspecao/tipoinspecao-inserir/tipoinspecao-inserir.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_sigobra_tipoinspecao_service__WEBPACK_IMPORTED_MODULE_5__["TipoinspecaoService"], _model_base__WEBPACK_IMPORTED_MODULE_2__["Base"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
], TipoinspecaoInserirPage);
...
//# sourceMappingURL=pages-tipoinspecao-tipoinspecao-inserir-tipoinspecao-inserir-module-es2015.js.map