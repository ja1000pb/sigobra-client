    ...
    var InspecaoInserirPage = /*#__PURE__*/function () {
      ...
      _createClass(InspecaoInserirPage, [{
        ...
        value: function editar() {
          ...
          return this.is.edit(this.inspecao).subscribe(function (data) {
            _this4.base.dismiss();
            ...
            _this4.base.mensagemErro('Falha  ao Editar  inspecao ' + _this4.inspecao.id + _this4.inspecao.ativo + _this4.base.tratarErro(error));
          });
        }
      }, {
        key: "selecionarobra",
