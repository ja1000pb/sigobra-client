...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TipoinspecoesPageRoutingModule", function() { return TipoinspecoesPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _tipoinspecoes_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./tipoinspecoes.page */ "./src/app/pages/tipoinspecao/tipoinspecoes/tipoinspecoes.page.ts");
...
let TipoinspecoesPageRoutingModule = class TipoinspecoesPageRoutingModule {
};
TipoinspecoesPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TipoinspecoesPageModule", function() { return TipoinspecoesPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/fesm2015/ionic-angular.js");
/* harmony import */ var _tipoinspecoes_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./tipoinspecoes-routing.module */ "./src/app/pages/tipoinspecao/tipoinspecoes/tipoinspecoes-routing.module.ts");
/* harmony import */ var _tipoinspecoes_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./tipoinspecoes.page */ "./src/app/pages/tipoinspecao/tipoinspecoes/tipoinspecoes.page.ts");
...
let TipoinspecoesPageModule = class TipoinspecoesPageModule {
};
TipoinspecoesPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
            _tipoinspecoes_routing_module__WEBPACK_IMPORTED_MODULE_5__["TipoinspecoesPageRoutingModule"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TipoinspecoesPage", function() { return TipoinspecoesPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _model_objetc_tipoinspecao__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../../../model/objetc/tipoinspecao */ "./src/app/model/objetc/tipoinspecao.ts");
/* harmony import */ var _service_sigobra_tipoinspecao_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./../../../service/sigobra/tipoinspecao.service */ "./src/app/service/sigobra/tipoinspecao.service.ts");
...
let TipoinspecoesPage = class TipoinspecoesPage {
    constructor(base, tis, router) {
        this.base = base;
        this.tis = tis;
        this.router = router;
        this.value = '';
    ...
    excluir(tipoinspecao) {
        this.base.Confirma('Deseja excluir essa empresa', this.removerativo.bind(this), tipoinspecao);
    }
    remover(tipoinspecao) {
        this.base.present();
        return this.tis.delete(tipoinspecao).subscribe(data => {
            this.base.dismiss();
            this.base.menssagemSucesso('Tipo inspecao Excluida');
        }, error => {
            this.base.dismiss();
            this.base.mensagemErro('Falha  ao Excluir  empresa ' + tipoinspecao.id + this.base.tratarErro(error));
        });
    }
    editar(tipoinspecao) {
    ...
    carregartipoinspecao(value) {
        this.base.present();
        return this.tis.pesquisar(value).subscribe(data => {
            this.tipoinspecoes = data;
            this.base.dismiss();
        }, error => {
            this.base.dismiss();
            this.base.mensagemErro('Falha  ao listar  tipoinspecao ' + this.base.tratarErro(error));
        });
    }
    carregartipoinspecoes(value) {
        this.base.present();
        return this.tis.pesquisa(value).subscribe(data => {
            this.tipoinspecoes = data;
            this.base.dismiss();
        }, error => {
            this.base.dismiss();
    ...
    removerativo(tipoinspecao) {
        ...
        return this.tis.editarativo(this.tipoinspecao).subscribe(data => {
            this.base.dismiss();
            this.router.navigate(['tipoinspecoes']);
        }, error => {
            this.base.dismiss();
            this.base.mensagemErro('Falha  ao Excluir  tipoinspecao' + this.tipoinspecao.id + this.tipoinspecao.ativo
                + this.base.tratarErro(error));
        });
    }
};
TipoinspecoesPage.ctorParameters = () => [
...
TipoinspecoesPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-tipoinspecoes',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./tipoinspecoes.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/tipoinspecao/tipoinspecoes/tipoinspecoes.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./tipoinspecoes.page.scss */ "./src/app/pages/tipoinspecao/tipoinspecoes/tipoinspecoes.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_model_base__WEBPACK_IMPORTED_MODULE_5__["Base"], _service_sigobra_tipoinspecao_service__WEBPACK_IMPORTED_MODULE_4__["TipoinspecaoService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
], TipoinspecoesPage);
...
//# sourceMappingURL=pages-tipoinspecao-tipoinspecoes-tipoinspecoes-module-es2015.js.map