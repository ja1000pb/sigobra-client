...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~login-login-module~menu-menu-module~pages-dashboard-tarefas-tarefas-module~pages-empresa-emp~9c81ffdb"], {
  ...
  /***/
  function srcAppModelBaseTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Base = /*#__PURE__*/function () {
      ...
      _createClass(Base, [{
        ...
        key: "mensagemErro",
        value: function mensagemErro(msg) {
        ...
        key: "mensagemAlerta",
        value: function mensagemAlerta(msg) {
        ...
        key: "menssagemSucesso",
        value: function menssagemSucesso(msg) {
          this.toast.create({
            message: msg,
            duration: 5000,
            position: 'middle',
        ...
        key: "toFloatString",
        value: function toFloatString(value) {
          var result = parseFloat(value.toString().replace(',', ''));
          console.log(result);
          return result;
        }
