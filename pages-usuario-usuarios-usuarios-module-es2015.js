...
/* harmony import */ var _usuarios_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./usuarios.page */ "./src/app/pages/usuario/usuarios/usuarios.page.ts");
...
/* harmony import */ var _usuarios_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./usuarios-routing.module */ "./src/app/pages/usuario/usuarios/usuarios-routing.module.ts");
/* harmony import */ var _usuarios_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./usuarios.page */ "./src/app/pages/usuario/usuarios/usuarios.page.ts");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _app_model_base__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../../../../app/model/base */ "./src/app/model/base.ts");
/* harmony import */ var _service_sigobra_usuario_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../../../service/sigobra/usuario.service */ "./src/app/service/sigobra/usuario.service.ts");
...
let UsuariosPage = class UsuariosPage {
    ...
    pesquisa(value) {
        this.base.present();
        return this.us.pesquisar(value).subscribe(data => {
            this.usuarios = data;
            this.base.dismiss();
        }, error => {
            this.base.dismiss();
    ...
    pesquisar(value) {
        this.base.present();
        return this.us.pesquisa(value).subscribe(data => {
            this.usuarios = data;
            this.base.dismiss();
        }, error => {
            this.base.dismiss();
...
UsuariosPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./usuarios.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/usuario/usuarios/usuarios.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./usuarios.page.scss */ "./src/app/pages/usuario/usuarios/usuarios.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _app_model_base__WEBPACK_IMPORTED_MODULE_1__["Base"], _service_sigobra_usuario_service__WEBPACK_IMPORTED_MODULE_2__["UsuarioService"]])
], UsuariosPage);
...
//# sourceMappingURL=pages-usuario-usuarios-usuarios-module-es2015.js.map