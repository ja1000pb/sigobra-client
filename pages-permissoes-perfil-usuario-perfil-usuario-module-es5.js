...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-permissoes-perfil-usuario-perfil-usuario-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesPermissoesPerfilUsuarioPerfilUsuarioPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesPermissoesPerfilUsuarioPerfilUsuarioRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesPermissoesPerfilUsuarioPerfilUsuarioModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    PerfilUsuarioPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _perfil_usuario_routing_module__WEBPACK_IMPORTED_MODULE_5__["PerfilUsuarioPageRoutingModule"]],
  ...
  /***/
  function srcAppPagesPermissoesPerfilUsuarioPerfilUsuarioPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesPermissoesPerfilUsuarioPerfilUsuarioPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var PerfilUsuarioPage = /*#__PURE__*/function () {
      function PerfilUsuarioPage(pa, base, router) {
      ...
      _createClass(PerfilUsuarioPage, [{
        ...
        value: function permissaoUsuario() {
          this.router.navigate(['permissao-usuario']);
        }
      }, {
        key: "editar",
        value: function editar(perfilUsuario) {
        ...
        value: function pesquisarPerfilUsuario(value) {
          ...
          this.base.present();
          this.pa.pesquisarPerfilUsuario(value).subscribe(function (data) {
            _this.perfisUsuarios = data;

            _this.base.dismiss();
          }, function (error) {
            _this.base.mensagemErro('Falha ao consultar perfil usuário ' + _this.base.tratarErro(error));
        ...
        key: "deletar",
        value: function deletar(perfilUsuario) {
          var _this2 = this;

          this.base.present();
          this.pa.deletarPerfilUsuario(perfilUsuario).subscribe(function (data) {
            _this2.perfisUsuarios = data;

            _this2.base.dismiss();
          }, function (error) {
            _this2.base.mensagemErro('Falha ao excluir perfil usuário ' + _this2.base.tratarErro(error));
        ...
        value: function pesquisarPerfilUsuario1() {
          var _this3 = this;

          this.base.present();
          this.pa.pesquisarPerfilUsuario1(this.value).subscribe(function (data) {
            _this3.perfisUsuarios = data;

            _this3.base.dismiss();
          }, function (error) {
            _this3.base.mensagemErro('Falha ao consultar perfil usuário ' + _this3.base.tratarErro(error));
    ...
    PerfilUsuarioPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/permissoes/perfil-usuario/perfil-usuario.page.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./perfil-usuario.page.scss */
      "./src/app/pages/permissoes/perfil-usuario/perfil-usuario.page.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_sigobra_permissoes_acesso_service__WEBPACK_IMPORTED_MODULE_2__["PermissoesAcessoService"], _model_base__WEBPACK_IMPORTED_MODULE_3__["Base"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])], PerfilUsuarioPage);
    /***/
  }
}]);
//# sourceMappingURL=pages-permissoes-perfil-usuario-perfil-usuario-module-es5.js.map