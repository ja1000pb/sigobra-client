...
/* harmony import */ var _tarefas_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./tarefas-routing.module */ "./src/app/pages/dashboard/tarefas/tarefas-routing.module.ts");
/* harmony import */ var _tarefas_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./tarefas.page */ "./src/app/pages/dashboard/tarefas/tarefas.page.ts");
...
TarefasPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _tarefas_routing_module__WEBPACK_IMPORTED_MODULE_5__["TarefasPageRoutingModule"],
...
let TarefasPage = class TarefasPage {
    constructor(base, is, tis, siis, os, router) {
        this.base = base;
        this.is = is;
        this.tis = tis;
        this.siis = siis;
    ...
    realizar(inspecaoitem) {
        this.is.inspecao = inspecaoitem.inspecao;
        this.router.navigate(['inspecao-realizar']);
    }
    carregarinspecaoitens(value) {
        this.is.pesqitem(value).subscribe(data => {
            this.base.dismiss();
...
TarefasPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_model_base__WEBPACK_IMPORTED_MODULE_3__["Base"], _service_sigobra_inspecao_service__WEBPACK_IMPORTED_MODULE_6__["InspecaoService"], _service_sigobra_tipoinspecao_service__WEBPACK_IMPORTED_MODULE_7__["TipoinspecaoService"], _service_sigobra_statusitensinspecao_service__WEBPACK_IMPORTED_MODULE_8__["StatusitensinspecaoService"],
        _service_sigobra_obra_service__WEBPACK_IMPORTED_MODULE_9__["ObraService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
], TarefasPage);
